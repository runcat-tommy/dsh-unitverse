/**
 * dsh-unitverse — browser half (client module).
 *
 ...
 * ModuleLoader bundle served at `/plugins/dsh-unitverse/client.js`.
 */
...
/** Tab order: chat(0) < trajectory(10) < unitverse(20). */
const VIEW_ORDER = 20

export function apply(ctx: Context): void {
  // Dictionaries ride the plugin lifecycle: registered on apply, released with it.
  ctx.effect(() => ctx.locale.register(NS, { zh, en }), 'unitverse: dictionaries')
