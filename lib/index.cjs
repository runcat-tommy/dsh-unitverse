...
__export(index_exports, {
  ...
  convert: () => convert,
  convertDetailed: () => convertDetailed,
  ...
  roundSignificant: () => roundSignificant,
  stripDeltaMarker: () => stripDeltaMarker,
    ...
    output: {
      schema: {
        ...
        properties: {
          ...
          categoryEn: { type: "string", required: true, description: "Category name in English." },
          fromInput: { type: "string", required: true, description: "Source token exactly as passed by the caller." },
          toInput: { type: "string", required: true, description: "Target token exactly as passed by the caller." },
